...
const works = [
  {
    ...
    image: '/assets/photos/bored-participant.jpg', alt: 'A visitor participating in A Bored Game',
    second: '/assets/photos/bored-installation.jpg',
  ...
  },
  {
    ...
    image: '/assets/photos/too-cute-threatening.png', alt: 'Threatening character condition in Too Cute to Kill',
    second: '/assets/photos/too-cute-character.png',
  ...
  },
  {
    ...
    image: '/assets/seeing-sound-figure.png', alt: 'Generated image, waveform and spectrogram from Seeing Sound',
  ...
  },
  {
    ...
    image: '/assets/photos/grumpy-bear.jpg', alt: 'The Grumpy Bear interactive sonic prototype',
    second: '/assets/photos/grumpy-bear-front.jpg',
  ...
  },
  {
    ...
    image: '/assets/photos/in-bloom-installation.png', alt: 'Responsive paper flowers in the In Bloom installation',
    second: '/assets/photos/in-bloom-presentation.png',
  ...
  },
  {
    ...
    image: '/assets/photos/blushy-object.jpg', alt: 'Blushy, a suspended responsive cloud creature',
    second: '/assets/photos/blushy-encounter.jpg',
  ...
  },
  {
    ...
    image: '/assets/graffiti.png', alt: 'Graffiti Studio creative tool output',
  ...
  },
  {
    ...
    image: '/assets/photos/zen-studio-output.png', alt: 'Mandala created with Zen Studio',
    second: '/assets/photos/bitwise-process.jpg',
  ...
  },
  {
    ...
    image: '/assets/learning-football-formations.png', alt: 'Interactive football formations interface',
...
const papers = [
  ['2026', 'Seeing Sound', 'Audiovisual AI · mediated musicianship', 'Field recordings, diffusion-generated images and playable spectrograms become a compositional workflow of interpretation, prompting and curation.', [['Website', 'https://aimc2026-demo-anonymous.netlify.app/'], ['Paper', '/assets/seeing-sound-paper.pdf']], '/assets/seeing-sound-figure.png'],
  ['2026', 'Too Cute to Kill', 'Game research · behavioural study', 'A study with 36 participants measuring how character cuteness influences aggression in a non-hostile first-person shooting task.', [['Paper', '/assets/too-cute-to-kill.pdf']], '/assets/photos/too-cute-character.png'],
    ...
    <main ref={rootRef}>
      ...
      <section className="thesis-scene">
        ...
        <div className="thesis-stage">
          <figure className="thesis-screen" data-image-reveal><img src="/assets/thesis-live-interface.png" alt="AI-assisted misinformation judgment study interface" /><figcaption>LIVE STUDY INTERFACE · 25 TRIALS · FIVE EXPLANATION CONDITIONS</figcaption></figure>
          <aside data-reveal>
      ...
      <section className="about" id="about">
        <figure className="about-eye"><img src="/assets/photos/yuning-portrait.jpg" alt="Portrait of Yuning Yao" /><figcaption>YUNING YAO · 2026</figcaption></figure>
      ...
      <section className="contact-sheet">
        {[['/assets/photos/bored-team.jpg','WITH OTHERS'],['/assets/photos/blushy-electronics.jpg','BEFORE THE BODY'],['/assets/photos/bitwise-process.jpg','TEST / FAIL / REPEAT'],['/assets/photos/in-bloom-presentation.png','SHOW THE PROCESS']].map(([src, label]) => <figure key={src} data-image-reveal><img src={src} alt="" /><figcaption>{label}</figcaption></figure>)}
      </section>
